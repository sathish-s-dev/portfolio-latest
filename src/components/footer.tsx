...
const Footer = () => {
  return (
    // <footer id="footer" className="px-4 divide-y border-t border-slate-50/20">
    ...
    //         >
    //           <div className="flex items-center justify-center size-8 rounded-full bg-emerald-400 dark:bg-emerald-600">
    //             <svg
    ...
    //           <h3 className="tracking-wide uppercase text-slate-50">Product</h3>
    ...
    //         </div>
    //         <div className="space-y-3">
    //           <h3 className="tracking-wide uppercase text-slate-50">Company</h3>
    //           <ul className="space-y-1">
    //             <li>
    //               <Link rel="noopener noreferrer" href="/">
    //                 Privacy
    ...
    //         </div>
    //         <div className="space-y-3">
    //           <h3 className="uppercase text-slate-50">Developers</h3>
    //           <ul className="space-y-1">
    //             <li>
    //               <Link rel="noopener noreferrer" href="/">
    //                 Public API
    ...
    //         </div>
    //         <div className="space-y-3">
    //           <div className="uppercase text-slate-50">Social media</div>
    ...
    <footer id="footer" className="pt-12 relative border-t border-slate-50/20 dark:bg-black border-gray-400 bg-white">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <Link href="/" className="text-emerald-600 dark:text-emerald-300">
              {/* <svg
                className="h-8"
                viewBox="0 0 118 24"
                fill="none"
